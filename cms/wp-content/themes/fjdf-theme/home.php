...
acf_add_local_field_group( [
	...
	'fields' => [
		...
		[ 'key' => 'field_fjdf_hero_cta_url', 'label' => __( 'CTA Button URL', 'fjdf' ), 'name' => 'fjdf_hero_cta_url', 'type' => 'page_link' ],
		[
		...
		[ 'key' => 'field_fjdf_about_cta_url', 'label' => __( 'CTA Button URL', 'fjdf' ), 'name' => 'fjdf_about_cta_url', 'type' => 'page_link' ],
		...
		[ 'key' => 'field_fjdf_what_cta_url', 'label' => __( 'CTA Button URL', 'fjdf' ), 'name' => 'fjdf_what_cta_url', 'type' => 'page_link' ],
		...
		// Portrait image shown left of stats (same for all tabs)
		[
		...
		[ 'key' => 'field_fjdf_cta_button_url', 'label' => __( 'Button URL', 'fjdf' ), 'name' => 'fjdf_cta_button_url', 'type' => 'page_link' ],
		[
